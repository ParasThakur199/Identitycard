...
//			topCanvas.add(infoTable);
			...
			LocalDate dobLocalDate = LocalDate.parse(dobDate, inputFormatter);
			String formattedDobDate = outputFormatter.format(dobLocalDate);
			...
			// Details beside photo
						...
						detailsCell1.add(new Paragraph().add(new Text("जन्म तिथि / Date of Birth:    ").setFont(hindiFont))
								.add(new Text(formattedDobDate)).setFontSize(10).setMultipliedLeading(1f)
								.setMarginTop(0).setMarginBottom(0));
						...
						fieldsCell2.add(new Paragraph().add(new Text("आपातकालीन संपर्क / Emegency Contact:    ").setFont(hindiFont))
								.add(new Text(entity.getEmergencycontactname())).add(new Text(" / ")).add(new Text(entity.getEmergencycontactno())).setFontSize(10).setMultipliedLeading(1f)
								.setMarginTop(0).setMarginBottom(0));
			...
			bottomCanvas
					.add(new Paragraph().add(new Text("कार्यालय पता / Office Address:    ").setFont(hindiFont)).add(new Text(entity.getOfficeaddress())).setFontSize(10).setMultipliedLeading(1f)
